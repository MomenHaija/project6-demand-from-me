    ...
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (reader.Read())
            {
                ...
                $"<p>{reader[1]}</p>" +
                $"<p><a href=\"http://localhost:53925/Single%20category%20project%20.aspx?category_id={reader[0]}&category_name={reader[1]}\" class=\"btn btn-info\">See Books</a></p>" +
                "</div></div>";
            ...
            if (TextBox1.Text != string.Empty || TextBox1.Text != "" || TextBox1.Text != null)
            {
                ...
                while (reader.Read())
                {
                    Label2.Text += "<div class=\"book read\">" +
                        ...
                        $"<p><a href =\"http://localhost:53925/Single%20category%20project%?book_id={reader[0]}\" class=\"btn btn-info\">See More Details</a></p>" +
                        "</div></div>";
                }
